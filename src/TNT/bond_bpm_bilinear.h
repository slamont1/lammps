...
#ifdef BOND_CLASS
// clang-format off
BondStyle(bpm/bilinear,BondBPMBilinear);
// clang-format on
#else

#ifndef LMP_BOND_BPM_BILINEAR_H
#define LMP_BOND_BPM_BILINEAR_H

#include "bond_bpm.h"

namespace LAMMPS_NS {

class BondBPMBilinear : public BondBPM {
 public:
  BondBPMBilinear(class LAMMPS *);
  ~BondBPMBilinear() override;
