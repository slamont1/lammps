...
PairExponential2::PairExponential2(LAMMPS *lmp) : Pair(lmp)
{
  writedata = 1;
}
...
PairExponential2::~PairExponential2()
{
  if (copymode) return;
...
void PairExponential2::compute(int eflag, int vflag)
{
...
void PairExponential2::allocate()
{
  allocated = 1;
...
void PairExponential2::settings(int narg, char **arg)
{
...
void PairExponential2::coeff(int narg, char **arg)
{
...
double PairExponential2::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairExponential2::write_restart(FILE *fp)
{
...
void PairExponential2::read_restart(FILE *fp)
{
...
void PairExponential2::write_restart_settings(FILE *fp)
{
...
void PairExponential2::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairExponential2::write_data(FILE *fp)
{
...
void PairExponential2::write_data_all(FILE *fp)
{
...
double PairExponential2::single(int /*i*/, int /*j*/, int itype, int jtype,
                                 double rsq,
