...
#ifdef BOND_CLASS
// clang-format off
BondStyle(bpm/altrotational,BondBPMAltrotational);
// clang-format on
#else

#ifndef LMP_BOND_BPM_ALTROTATIONAL_H
#define LMP_BOND_BPM_ALTROTATIONAL_H

#include "bond_bpm.h"

namespace LAMMPS_NS {

class BondBPMAltrotational : public BondBPM {
 public:
  BondBPMAltrotational(class LAMMPS *);
  ~BondBPMAltrotational() override;
