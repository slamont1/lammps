...
#ifdef FIX_CLASS
// clang-format off
FixStyle(bond/rupturess,FixBondRupturess);
// clang-format on
#else

#ifndef LMP_FIX_BOND_RUPTURESS_H
#define LMP_FIX_BOND_RUPTURESS_H

#include "fix.h"

namespace LAMMPS_NS {

class FixBondRupturess : public Fix {
 public:
  FixBondRupturess(class LAMMPS *, int, char **);
  virtual ~FixBondRupturess();
  int setmask();
